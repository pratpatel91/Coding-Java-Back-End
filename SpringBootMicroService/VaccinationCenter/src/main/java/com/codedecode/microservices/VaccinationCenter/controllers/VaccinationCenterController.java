...
public class VaccinationCenterController {
	...
	//----------http://localhost:8082/vaccinationcenter/add
	...
	//----------http://localhost:8082/vaccinationcenter/id/1
	...
	public ResponseEntity<RequiredResponse> getAllDataBasedonCenterId(@PathVariable Integer id){
		...
		List<Citizen> listOfCitizens = restTemplate.getForObject(
				"http://CITIZEN-SERVICE/citizen/id/"+id,List.class);
