...
* The original package name 'spring-boot-kafka-hello-world-example.spring-boot-kafka-hello-world-example' is invalid and this project uses 'springbootkafkahelloworldexample.springbootkafkahelloworldexample' instead.
